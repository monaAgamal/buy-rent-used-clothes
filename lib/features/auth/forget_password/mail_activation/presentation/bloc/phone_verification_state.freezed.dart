...
abstract class Initial implements PhoneVerificationState {
...
abstract class Loading implements PhoneVerificationState {
...
class _$IsEnabled implements IsEnabled {
  const _$IsEnabled({required this.isEnaled});
  ...
  @override
  String toString() {
    return 'PhoneVerificationState.isEnabled(isEnaled: $isEnaled)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(isEnaled));
...
abstract class IsEnabled implements PhoneVerificationState {
  const factory IsEnabled({required final bool isEnaled}) = _$IsEnabled;
...
class _$SuccessfullyVerfied implements SuccessfullyVerfied {
  const _$SuccessfullyVerfied();

  @override
  String toString() {
    return 'PhoneVerificationState.successfullyVerfied()';
  }
